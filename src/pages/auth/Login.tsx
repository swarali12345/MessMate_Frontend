    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-main/10 via-accent-main/40 to-background-main px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 border border-gray-100">
        ...
        <form className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input id="remember" name="remember" type="checkbox" className="h-4 w-4 text-primary-main focus:ring-primary-main border-gray-300 rounded" />
              <label htmlFor="remember" className="ml-2 block text-sm text-gray-600">
                Remember me
              </label>
            </div>
            <Link to="/auth/forgot-password" className="text-sm text-primary-main hover:underline font-medium">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="text-center text-base text-gray-600">
          ...
          <Link to="/auth/register" className="text-primary-main font-semibold hover:underline">Register</Link>
        </p>
      </div>
    </div>
  );
